...
1. Clone this repository to your local machine or use Replit > [![Try with Replit Badge](https://replit.com/badge?caption=Install)](https://replit.com/new/github/mogelpeter/active-developer-badge)
